...
function About() {
    ...
    return (
        <section id="About" data-aos="fade-up">
            ...
            <Card className="row" data-aos="fade-left">
                <div className="about-content">
                    ...
                    <button data-aos="fade-up" className="btn btn-info  p-2 text-white text-bold mt-3" onClick={readMore}> {!read ? "Read more" : "Read less"} </button>
                </div>
            </div>
        </section>
    )

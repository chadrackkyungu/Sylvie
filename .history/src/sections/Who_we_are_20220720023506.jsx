            ...
            <CardBody>
                ...
                <Row className="row mt-5 mt-5">
                    <Col md={6} data-aos="fade-right">
                        <Card className="bg-black">
                            <CardBody>
                                <h3> <FcComboChart size={60} className="me-4" />  Our Mission</h3>
                    ...
                    <Col md={6} data-aos="fade-left">
                        <CardBody>
                            <h3> <FcLineChart size={60} className="me-4" /> Our Vision</h3>
                            <p>
                ...
                <Row className="row mt-5 mt-5">
                    <Col md={6} data-aos="fade-right">
                        <Card className="bg-black">
                            <CardBody>
                                <h3><MdAddChart size={60} className="me-4" /> Values</h3>
                    ...
                    <Col md={6} data-aos="fade-left">
                        <CardBody>
                            <h3> <GiFlagObjective size={60} className="me-4" /> Objective</h3>
                            <p>
                ...
                <Row className="row mt-5 mt-5">
                    <Col md={6} data-aos="fade-right">
                        <Card className="bg-black">
                            <CardBody>
                                <h3> <GiWeightLiftingUp size={60} className="me-4" /> Upliftment</h3>
                    ...
                    <Col md={6} data-aos="fade-left">
                        <CardBody>
                            <h3> <SiMaterialdesignicons size={60} className="me-4" /> Procurement</h3>
                            <p>

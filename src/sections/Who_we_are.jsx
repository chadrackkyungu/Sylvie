...
function Who() {
    ...
    return (
        <Card id="Who" data-aos="fade-up" className="bg-section m-3">
            <CardBody>
                <MetaTags>
                ...
                <Row className="row mt-5 mt-5">
                    <Col md={6} data-aos="fade-right">
                        <Card className="bg-black">
                            <CardBody>
                                <h3> <GiWeightLiftingUp size={60} className="me-4 icons" /> Upliftment</h3>
                    ...
                    <Col md={6} data-aos="fade-left">
                        <CardBody>
                            <h3> <SiMaterialdesignicons size={60} className="me-4 icons" /> Procurement</h3>
                            <p>
